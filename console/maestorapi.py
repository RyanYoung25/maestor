...
def ls():
    return ['/loadTrajectory', '/command', '/setProperties', '/unignoreFrom', '/requiresMotion', '/getProperties', '/ignoreAllFrom', '/initRobot', '/startTrajectory', '/ignoreFrom', '/setTrigger', '/unignoreAllFrom', '/setProperty', '/extendTrajectory', '/stopTrajectory']
